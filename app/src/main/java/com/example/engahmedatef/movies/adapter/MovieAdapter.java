package com.example.engahmedatef.movies.adapter;
...
import com.example.engahmedatef.movies.controller.activity.Details_Activity;
...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.MovieHolder> {
    ...
    public void onBindViewHolder( MovieHolder holder, int position) {
        ...
        if (position == 0 ){
            ...
            NYBus.get().post(movie , Channel.ONE); // if position of movie is 0 --> display frist movie (if isLand)
        }
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ( ! m_context.getResources().getBoolean(R.bool.isLand)){ // if portrait No tablet
